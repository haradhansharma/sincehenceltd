    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('organization', models.CharField(blank=True, max_length=252, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar', imagekit.models.fields.ProcessedImageField(blank=True, null=True, upload_to='profile_photo')),
                ('about', models.TextField(blank=True, max_length=500, null=True, verbose_name='About Me')),
                ('location', models.CharField(blank=True, max_length=30, null=True, verbose_name='My Location')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='gateway_references', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Address',
